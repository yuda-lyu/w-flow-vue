    ...
    data: function() {
        return {
            ...
            'opt': {
                ...
                height: 600,
                nodes: [
                    { id: '1', name: '資料來源', description: '從外部 API 取得原始資料', position: { x: 260, y: 0 }, edgeColor: '#0041d0', width: 100, height: 40 },
                    { id: '2', name: '資料驗證', description: '檢查資料格式與完整性', position: { x: 100, y: 120 }, width: 100, height: 40 },
                    { id: '3', name: '資料轉換', description: '將原始資料轉換為標準格式', position: { x: 400, y: 120 }, width: 100, height: 40 },
                    { id: '8', name: '條件判斷', description: '根據條件分流處理', position: { x: 100, y: 220 }, shape: 'diamond', width: 120, height: 80 },
                    { id: '4', name: '商業邏輯', description: '執行核心商業規則與計算', position: { x: 80, y: 380 }, shape: 'ellipse', width: 140, height: 60 },
                    { id: '5', name: '資料聚合', description: '合併多個來源的處理結果', position: { x: 280, y: 500 }, edgeColor: '#ffa500', edgeWidth: 2, width: 100, height: 40 },
                    { id: '6', name: '輸出結果', description: '將最終結果寫入資料庫', position: { x: 160, y: 620 }, width: 100, height: 40 },
                    { id: '7', name: '通知服務', description: '發送處理完成通知給相關人員', position: { x: 400, y: 620 }, edgeColor: '#ff69b4', width: 100, height: 40 },
                    { id: '9', name: '過濾器', description: '過濾不符合條件的資料', position: { x: 620, y: 80 }, shape: 'triangle-up', width: 100, height: 80 },
                    { id: '10', name: '路由分配', description: '根據規則分配至不同處理管道', position: { x: 620, y: 220 }, shape: 'triangle-right', width: 100, height: 80 },
                    { id: '11', name: '資料壓縮', description: '壓縮資料以減少儲存空間', position: { x: 620, y: 360 }, shape: 'triangle-down', width: 100, height: 80 },
                    { id: '12', name: '快取處理', description: '從快取中讀取或寫入資料', position: { x: 620, y: 500 }, shape: 'triangle-left', width: 100, height: 80 },
                ],
                conns: [
                    { id: 'e1-2', from: '1', to: '2', type: 'bezier', animated: true, name: '原始資料', description: '未經處理的 API 回應' },
                    { id: 'e1-3', from: '1', to: '3', type: 'bezier', name: '備份資料', description: '同步至轉換流程', markerTo: 'arrowclosed' },
                    ...
                    { id: 'e3-5', from: '3', to: '5', type: 'step', name: '轉換完成', description: '標準化後的資料', markerFrom: 'arrow', markerTo: 'arrowclosed', markerToSize: 14, markerToFaceColor: '#ffa500' },
