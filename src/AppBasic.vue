        ...
        return {
            ...
            'opt': {
                ...
                nodes: [
                    ...
                    { id: '9', name: '過濾器', description: '過濾不符合條件的資料', position: { x: 620, y: 80 }, shape: 'triangle', width: 100, height: 80 },
                ...
                conns: [
                    ...
                    { id: 'e3-5', from: '3', to: '5', type: 'step', name: '轉換完成', description: '標準化後的資料', markerStart: 'arrow', markerEnd: 'arrowclosed', markerEndSize: 14, markerEndColor: '#ffa500' },
