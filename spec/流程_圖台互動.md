...
- **E2E-028** 按住 `Shift` 於空白畫布拖曳 → 出現選取框,框內節點呈選取態;**連線不參與框選複選**(連線為起訖節點錨點/轉折點推得之衍生物,不視為可被複選之項目),故框選一律清空連線選取。
...
合計 44 張:30 個 case 各 1 張,E2E-002 佔 12 張,E2E-032 佔 2 張(同 case 兩階段:invalid hover / valid hover)。
